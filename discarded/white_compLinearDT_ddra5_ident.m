...
lookup_ddra = struct( ...
    ...
    'c_v', zeros(dim_y, 1), ... % Center vector for measurement noise
    'alpha_v', 0.0, ... % Scaling factor for the generator matrix of measurement noise
    'eta_v', 1, ... % Number of generators for measurement noise
    'dim_x', dim_x, ...
    'dim_y', dim_y, ...
    'dim_u', dim_u, ...
...
dyn = "ddra5_ident"; % dynamics (choose from "platoon", "pedestrian")
